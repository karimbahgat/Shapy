		...
		for poly in raw:
			...
			if wn > 0: #modified, orig wn == 1 on right side
				output.append(Polygon.from_pointlist(poly))
        			#img.drawpolygon([(ver.x,ver.y) for ver in poly], fillcolor=(0,222,0), outlinecolor=(0,0,0))
			#else: img.drawpolygon([(ver.x,ver.y) for ver in poly], fillcolor=(222,0,0), outlinecolor=(0,0,0))
