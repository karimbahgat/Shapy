...
def process_file(filename):
    ...
    writer = open(filename[:-4]+"_conv.py","w")
    lines = reader.readlines()  # probably would die on sources more than 100 000 lines :D
    #reader.seek(0)
    #reader.truncate(0)
    for line in lines:
        #print line
        writer.write(process_line(line))
    writer.close()


if __name__ == '__main__':
    process_file(r"C:\Users\BIGKIMO\Downloads\clipper.cpp")
